...
description: >-
  規劃企業 Event、Webinar、Workshop、Conference 或 Roundtable 的 Audience、Value proposition、Registration、Promotion、Speaker／Content、Calendar、Reminder、Live engagement、Follow-up、Lead treatment 與 Measurement。
  適用於完整 Event marketing lifecycle；不適用於未核准大規模邀請、直接建立公開活動頁、猜測與會者或自動將出席者視為 Sales lead。
metadata:
  author: lwokeray
  version: "1.0.0"
---
