...
description: >-
  依 canonical Brand guide、Messaging、Terminology、Approved claims、Legal／Privacy、Accessibility、Localization 與 Channel requirements，對 Marketing content 進行逐項審查、分級、Before／After 修正與 Release recommendation。
  適用於發佈前 Editorial／Brand／Claim QA；不適用於把 Review 當正式 Legal approval、直接發布或在沒有基準時假裝品牌合規。
metadata:
  author: lwokeray
  version: "1.0.0"
---
