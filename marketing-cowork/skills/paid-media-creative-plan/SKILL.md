...
description: >-
  規劃 Paid search、Paid social、Display、Video、Sponsored content 與 Retargeting 的 Objective、Audience、Offer、Channel role、Budget scenario、Creative angles、完整 Copy variants、Visual brief、Experiment、Tracking、Policy QA 與 Optimization handoff。
  適用於新 Paid campaign 與 data-driven creative iteration；不適用於自動上傳 Audience、提交 Ads、承諾 Spend 或以過期平台限制產生 upload-ready 資產。
metadata:
  author: lwokeray
  version: "1.0.0"
---
