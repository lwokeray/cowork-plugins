...
description: >-
  建立、整併或更新企業 Brand voice、Audience promise、Messaging pillars、Tone spectrum、Terminology、Product naming、Approved claims 與使用規則，並以 Microsoft 365 核准資料維持版本治理。
  適用於 Brand system、Messaging framework、Style guide 與 Claim library；不適用於單篇內容審稿、Logo 視覺設計、商標法律判定或未核准發布。
metadata:
  author: lwokeray
  version: "1.0.0"
---
