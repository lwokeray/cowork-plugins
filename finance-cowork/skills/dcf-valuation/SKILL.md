...
name: dcf-valuation
description: >-
  依 Historical／Forecast financials、Unlevered free cash flow、WACC、Terminal value、Net debt、Other claims 與 Diluted shares 建立可稽核 DCF valuation、Enterprise-to-equity bridge、Scenario 與 Sensitivity。
  適用於 Corporate valuation、Strategic planning、Transaction／Investment analysis support；不適用於個人投資建議、證券買賣、未經來源支持的 Price target、只給單一精確值或將估值視為市場事實。
metadata:
  author: lwokeray
  version: "1.0.0"
---
