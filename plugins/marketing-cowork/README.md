...
python scripts/build_plugin.py marketing-cowork
```

部署 ZIP 根目錄只包含 `manifest.json`、`color.png`、`outline.png` 與 `skills/`。README、Prompt Cards 與 evals 為 Repository materials，不放入部署套件。
