...
description: 依核准的 Audience、Brand、Messaging、Claim、Proof、Channel 與 CTA，研究並撰寫可直接審閱的完整 Marketing content，包括 Blog、Thought leadership、Landing page、Case study、Press release、Newsletter、Executive brief 與 Short-video script。 適用於新稿、重寫與多版本創作；不適用於無來源 Claim、直接發布、假 Customer quote 或只交付製作摘要。
metadata:
  author: lwokeray
  version: 1.0.1
license: MIT
