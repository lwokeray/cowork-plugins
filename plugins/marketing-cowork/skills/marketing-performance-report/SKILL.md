...
description: 整合 Excel、SharePoint、Campaign files、approved exports 與 Microsoft 365 context，建立具 KPI 定義、Data quality、Period／Target comparison、Funnel／Channel、Budget、Attribution、Trend、Insight、Decision 與來源的 Marketing performance report。 適用於 Weekly／Monthly／Quarterly／Campaign／Channel review；不適用於用 vanity metric 宣稱成功、捏造 benchmark、在沒有 baseline 時宣稱 movement 或自動變更 Campaign。
metadata:
  author: lwokeray
  version: 1.0.1
license: MIT
