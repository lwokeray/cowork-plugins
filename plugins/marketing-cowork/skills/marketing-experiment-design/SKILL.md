...
description: 設計、檢查與分析 Marketing A/B 或 controlled experiment，涵蓋 Hypothesis、Unit、Randomization、Primary metric、Guardrail、MDE、Alpha、Power、Sample、Duration、SRM、Multiple testing、Confidence interval、Decision 與 Rollout。 適用於 Email、Landing page、Ad creative、Offer、Message、Channel 與 Journey experiments；不適用於用顯著性包裝壞資料、過早停止、操弄 Audience 或自動修改 Live campaign。
metadata:
  author: lwokeray
  version: 1.0.1
license: MIT
