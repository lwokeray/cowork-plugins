...
description: 設計具完整文案、Audience eligibility、Consent、Timing、Narrative arc、Branch、Suppression、Exit、CTA、Measurement 與 Approval 的 Marketing Email sequence，適用於 Newsletter、Onboarding、Nurture、Event、Launch、Re-engagement 與 Win-back。 不適用於未核准名單、Mass send、購買名單、猜測 Email、無限自動化或以 Outlook 取代正式 Marketing automation platform。
metadata:
  author: lwokeray
  version: 1.0.1
license: MIT
