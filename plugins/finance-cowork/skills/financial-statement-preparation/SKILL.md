...
description: 依核准 Trial Balance、Account mapping、Adjustments、Eliminations 與 Reporting policy 產製或審查 Income Statement、Balance Sheet、Cash Flow 與相關附表。 適用於 Monthly／Quarterly／Annual management statements、Consolidation、Comparative statements 與 Statement tie-out；不適用於直接 Posting、Statutory filing、Audit opinion、Tax return 或在未完成 Reconciliation 時宣告報表 Final。
metadata:
  author: lwokeray
  version: 1.0.1
license: MIT
