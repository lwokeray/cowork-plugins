...
description: 將 Actual、Budget、Forecast、Prior period 或 Prior year 的財務差異拆解為可驗證的 Price、Volume、Mix、Rate、Headcount、Timing、FX 與其他業務驅動因素。 適用於 P&L flux、Management commentary、Waterfall／Bridge、Forecast accuracy 與 Root-cause follow-up；不適用於製作原始 Financial Statements、建立 Budget model、主觀填補原因或未經證據調整 Forecast。
metadata:
  author: lwokeray
  version: 1.0.1
license: MIT
