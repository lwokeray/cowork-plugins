...
description: 依 Procurement、AP、Travel／Expense、Delegation 與 Accounting policy 審查 Vendor invoice 或 Employee expense 的完整性、Duplicate、PO／Receipt match、Coding、Cut-off、Tax fields、Exception 與核准證據。 適用於建立 Review queue、Exception register、Proposed coding 與 Reviewer packet；不適用於建立 Vendor、修改 Bank details、最終 Approval、Payment release、Employee disciplinary decision、Tax filing 或直接 Posting。
metadata:
  author: lwokeray
  version: 1.0.1
license: MIT
